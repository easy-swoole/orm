...
class WithTest extends TestCase
{
    ...
    {
        $result = TestRelationModel::create()->with(['hasOneEqName' => ['gaobinzhan1']])->where(['name' => 'gaobinzhan'])->get()->toArray(null, false);
        $this->assertEmpty($result['hasOneEqName']);
        $result = TestRelationModel::create()->with(['hasOneEqName' => ['gaobinzhan']])->where(['name' => 'gaobinzhan'])->get()->toArray(null, false);
